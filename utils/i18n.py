...
class I18n:
    """Gerencia traducoes e persistencia do idioma atual."""
    ...
    _translations = {
        "pt": {
            ...
            "left_all_channels": (
                "Saí de {count} canais de voz em todos os servidores."
            ),
            ...
            "processing_background": (
                "**{title}** está sendo processada em segundo plano!"
            ),
            ...
            "clear_invalid_channel": (
                "Este comando so funciona em canais de texto."
            ),
            "clear_need_manage_messages": (
                "Voce precisa da permissao Gerenciar mensagens para usar "
                "este comando."
            ),
            "clear_bot_missing_permissions": (
                "Eu preciso das permissoes Gerenciar mensagens e Ver "
                "historico de mensagens."
            ),
            "clear_success": (
                "Chat de musica limpo. Mensagens removidas: {count}."
            ),
            "clear_failed": (
                "Nao consegui limpar o chat. Verifique minhas permissoes."
            ),
            ...
            "radio_not_found": (
                "Rádio não encontrada. Use /radios para ver a lista de "
                "rádios disponíveis."
            ),
            "radio_added": "Rádio Adicionada",
            "radio_added_success": (
                "Rádio '{name}' adicionada com sucesso!\nUse "
                "`/radio {id}` para tocar."
            ),
        ...
        "en": {
            ...
            "left_all_channels": (
                "Left {count} voice channels across all servers."
            ),
            ...
            "processing_background": (
                "**{title}** is being processed in background!"
            ),
            ...
            "clear_bot_missing_permissions": (
                "I need Manage Messages and Read Message History permissions."
            ),
            "clear_success": "Music chat cleaned. Removed messages: {count}.",
            "clear_failed": (
                "I could not clean the chat. Check my permissions."
            ),
    ...
    def get(self, key, **kwargs):
        ...
        lang_dict = self._translations.get(
            self._language, self._translations["pt"]
        )
