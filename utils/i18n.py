...
class I18n:
    ...
    _translations = {
        "pt": {
            ...
            "clear_invalid_channel": "Este comando so funciona em canais de texto.",
            "clear_need_manage_messages": "Voce precisa da permissao Gerenciar mensagens para usar este comando.",
            "clear_bot_missing_permissions": "Eu preciso das permissoes Gerenciar mensagens e Ver historico de mensagens.",
            "clear_success": "Chat de musica limpo. Mensagens removidas: {count}.",
            "clear_failed": "Nao consegui limpar o chat. Verifique minhas permissoes.",
        ...
        "en": {
            ...
            "clear_invalid_channel": "This command only works in text channels.",
            "clear_need_manage_messages": "You need the Manage Messages permission to use this command.",
            "clear_bot_missing_permissions": "I need Manage Messages and Read Message History permissions.",
            "clear_success": "Music chat cleaned. Removed messages: {count}.",
            "clear_failed": "I could not clean the chat. Check my permissions.",
